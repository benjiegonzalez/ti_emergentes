        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <?php include_once('includes/topbar.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Detalles de la prueba# <?php echo intval($_GET['oid']);?></h1>
<div class="row">
<?php 
$testid=intval($_GET['tid']);
...
<!-- personal information --->
 ...
 <table class="table table-bordered"  width="100%" cellspacing="0">
    ...
    <td><?php echo $row['DateOfBirth'];?></td>
     ...
     <tr>
    <th>Identificación emitida por el gobierno</th> 
    <td><?php echo $row['GovtIssuedId'];?></td>
    </tr>


     <tr>
    <th>id emitida por el gobierno</th> 
    ...
    <tr>
    <th>Fecha de registro del perfil</th> 
...
<!-- Test Information --->
                         <div class="col-lg-6">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Información de la prueba</h6>
                                </div>
                                <div class="card-body">
...
<?php if($row['FinalReport']!=''):?>
  <tr>
    <th>Informe</th> 
    <td><a href="reportfiles/<?php echo $row['FinalReport'];?>" target="_blank">Descargar</a></td>
    </tr>

    <tr>
    <th>Tiempo de entrega del informe</th> 
...
<div class="row">
                         <div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary" align="center">Historial de seguimiento de pruebas</h6>
                                </div>
                                <div class="card-body">
<?php if($num>0){
?>
...
<tr>
    <th>Observación</th>
    <th>Estado</th>
    <th>Observación Fecha</th>
    <th>Observación por</th>
...
<h4 align="center" style="color:red"> No se encontró ningún historial de seguimiento </h4>
         <?php } ?>           
...
endwhile;
  ?>
            ...
            <option value="On the Way for Collection">En camino a la recogida</option>
            <option value="Sample Collected">Muestra recolectada</option>
            <option value="Sent to Lab">Enviado al laboratorio</option>
       ...
       <p id='reportfile'> Informe <span style="color:red; font-size:12px;">(Formato Doc y PDF permitido)</span>    <input type="file" name="report" id="report"></p>
       <p>

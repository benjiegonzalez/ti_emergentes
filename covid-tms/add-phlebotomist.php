  ...
  <div class="row">
     ...
     <div class="form-group">
                            <label>ID de empleado</label>
                                            <input type="text" class="form-control" id="empid" name="empid"  placeholder="Introduzca el ID del emprendimiento..."   required="true" onBlur="empidAvailability()">
                                                  <span id="empid-availability-status" style="font-size:12px;"></span>
                                        </div>

                        <div class="form-group">
                            <label>Nombre completo</label>
                                            <input type="text" class="form-control" id="fullname" name="fullname"  placeholder="Introduce tu nombre completo..." pattern="[A-Za-z ]+" title="letters only" required="true">
                                        </div>
                                        <div class="form-group">
                                             <label>Número de teléfono móvil</label>
                                  <input type="text" class="form-control" id="mobilenumber" name="mobilenumber" placeholder="Por favor, introduzca su número de móvil" pattern="[0-9]{10}" title="10 numeric characters only" required="true" >
